...
const Tablet = ({navigation}) => {
  const Card = ({tabs}) => {
    ...
    <TouchableHighlight
        activeOpacity={.1}
        underlayColor="white"
        onPress={() => navigation.navigate('Details', tabs)}>
    <View style={styles.cardRounded}>
        ...
        />
        <Text style = {styles.nameCategories}>{tabs.title}</Text>
        <Text style = {styles.productPrice}>₱ {tabs.price}</Text>
        </View>
    </View>
    </TouchableHighlight>
  );
    ...
    return(
      ...
      style = {{
        ...
        <View style = {styles.header}>
            ...
            <Text style = {styles.title}>Tablet</Text>
...
const tab = [
  ...
  {
  id: 2,
  url: require('./img/AcerIronia.jpg'),
  title: "Acer Iconia One 10 T4-129L Tablet",
  ...
  {
  id: 3,
  url: require('./img/Samsungtab.png'),
